...
\begin{document}
    ...
    \begin{enumerate}
        ...
        %References
        \textit{Note --- Provisions for the use of an ATS surveillance system in the aerodrome control service are contained in Chapter 8, Section 8.10.}
    ...
    \begin{enumerate}[label=\arabic{section}.\arabic{subsection}.\arabic*]
        ...
        \textit{Note --- Separate or multiple runways may be designated runway-in-use for arriving aircraft and departing aircraft.}
    ...
    %References
    \textit{Note --- See also Chapter 4, 4.11.3, for aircraft in the air, making the first call to the aerodrome tower.}
    ...
    \begin{enumerate}[itemsep=0.2cm]\centering
        ...
        \begin{enumerate}
            ...
            %References
            \textit{Note --- The meteorological information listed above is to follow the criteria used for meteorological local routine and special reports, in accordance with Chapter 11, 11.4.3.2.2 to 11.4.3.2.3.}
        ...
        \begin{enumerate}
            ...
            \textit{Note --- The provisions in \ref{7.4.1.4.2} have the objective of supporting the State’s safety programme and safety management system (SMS).}
        \end{enumerate}
        ...
        \begin{enumerate}
            ...
            \textit{Note --- Jet blast and propeller slipstream can produce localized wind velocities of sufficient strength to cause damage to other aircraft, vehicles and personnel operating within the affected area.}
        \end{enumerate}
    ...
    \begin{enumempty}[labelindent=\parindent]
        %References
        \item \textit{Note --- See Chapter 11, 11.4.3.4, regarding messages containing information on aerodrome conditions.}
    \end{enumempty}
    ...
    \begin{enumerate}[label=\arabic{section}.\arabic{subsection}.\arabic*]
        ...
        \textit{Note --- ``Other sources" include NOTAM, ATIS broadcasts, and the display of suitable signals.}
    ...
    \textit{Note 1 --- Arriving aircraft executing an instrument approach procedure will normally enter the traffic circuit on final except when visual manoeuvring to the landing runway is required.}

    \textit{Note 2 --- See Figure \ref{fig:7-1}.}
    ...
    \begin{enumerate}[itemsep=0.2cm]\centering
        ...
        \begin{enumerate}[labelindent=0pt,itemsep=0.2cm]
            ...
            \begin{enumerate}
                ...
                \textit{Note --- Runway-holding position locations in relation to runways are specified in Annex 14, Volume I, Chapter 5.}
                ...
                \textit{Note --- See Figure \ref{fig:7-2}.}
            \end{enumerate}
            ...
            \begin{enumerate}
                ...
                \textit{Note --- Ground taxiing uses less fuel than air-taxiing and minimizes air turbulence. However, under certain conditions, such as rough, soft or uneven terrain, it may become necessary to air-taxi for safety considerations. Helicopters with articulating rotors (usually designs with three or more main rotor blades) are subject to ``ground resonance" and may, on rare occasions, suddenly lift off the ground to avoid severe damage or destruction.}
                ...
                \textit{Note --- Air-taxiing consumes fuel at a high burn rate, and helicopter downwash turbulence (produced in ground effect) increases significantly with larger and heavier helicopters.}
                ...
                \textit{Note --- Most light helicopters are flown by one pilot and require the constant use of both hands and feet to maintain control during low-altitude/low-level flight. Although flight control friction devices assist the pilot, changing frequency near the ground could result in inadvertent ground contact and consequent loss of control.}
            \end{enumerate}
        \end{enumerate}
    ...
    \begin{enumerate}
        ...
        %References
        \textit{Note --- An aircraft which has encountered an emergency is handled as outlined in Chapter 15, Section 15.1.}
    \end{enumerate}
    ...
    \textit{Note 1 --- See Figure \ref{fig:7-3}.}

    %References
    \textit{Note 2 --- Wake turbulence categories and time-based wake turbulence longitudinal separation minima are contained in Chapter 4, Section 4.9 and Chapter 5, Section 5.8, respectively. Distance-based wake turbulence separation minima are contained in Chapter 8, Section 8.7.}

    \textit{Note 3 --- See \ref{7.6.3.1.2.2}.}
    ...
    \begin{enumerate}
        ...
        \textit{Note --- The expression TORA, pronounced TOR-AH, may be used to indicate take-off run available.}
    ...
    %References
    \textit{Note 2 --- Wake turbulence categories of aircraft and longitudinal separation minima are contained in Chapter 4, Section 4.9 and Chapter 5, Section 5.8, respectively.}
    ...
    \begin{enumempty}[labelindent=\parindent]
        \item \textit{Note --- These procedures apply whenever conditions are such that all or part of the manoeuvring area cannot be visually monitored from the control tower. Additional requirements which apply when category II/III approaches are being conducted are specified in Section \ref{7.12.2}.}
    \end{enumempty}
    ...
    \begin{enumerate}
        ...
        \textit{Note --- The \emph{Manual of Surface Movement Guidance and Control Systems (SMGCS)} (Doc 9476) provides guidance on surface movement guidance and control components and procedures for low visibility operations.}
    \end{enumerate}
    ...
    \begin{enumerate}
        ...
        \textit{Note --- Further information regarding the requirements for low visibility operations can be found in the \emph{Air Traffic Services Planning Manual} (Doc 9426) and the \emph{All-Weather Operations Manual} (Doc 9365).}
    ...
    \begin{enumerate}[label=\arabic{section}.\arabic{subsection}.\arabic*]
        ...
        \textit{Note --- Requirements for two-way communications between controlled flights and the appropriate air traffic control unit are contained in Annex 2, 3.6.5.}
    \end{enumerate}
    ...
    \textit{Note --- Guidance material related to hot spots is contained in the \emph{Manual on the Prevention of Runway Incursions} (Doc 9870).}
