...
\begin{document}
    ...
    \begin{enumerate}[itemsep=0.2cm]\centering
        ...
        \begin{enumempty}
            ...
            %References
            \textit{Note --- The provisions applying to standardized procedures for coordination and transfer of control are specified in Chapter 10, Section 10.1.1.}
        \end{enumempty}
        ...
        \begin{enumempty}[labelindent=\parindent]
            \item \textit{Note 1 --- See \ref{6.3.2.4.1} for clearances to aircraft on SID.}

            \item \textit{Note 2 --- The use of a SID designator without a cleared level does not authorize the aircraft to climb on the SID vertical profile.}
        \end{enumempty}
    ...
    \begin{enumerate}[itemsep=0.2cm]\centering
        ...
        \begin{enumempty}
            ...
            \textit{Note 1 --- See \ref{6.5.2.4.1} for clearances on a STAR.}

            \textit{Note 2 --- The use of a STAR designator without a cleared level does not authorize the aircraft to descend on the STAR vertical profile.}
        \end{enumempty}
    ...
    \begin{enumerate}[itemsep=0.2cm]\centering
        ...
        \begin{enumerate}
            ...
            \begin{enumalph}
                ...
                \textit{Note --- See \ref{6.5.6.2.1} concerning timed approach procedures.}
    ...
    \begin{enumerate}[label=\arabic{section}.\arabic{subsection}.\arabic*]
        ...
        %References
        \textit{Note ---The meteorological information listed above is identical to that required in ATIS broadcasts for arriving aircraft as specified in Annex 11, 4.3.7 l) to t), and is to be extracted from local meteorological routine and special reports, in accordance with Chapter 11, 11.4.3.2.2 to 11.4.3.2.3.}
        ...
        \begin{enumalph}
            ...
            \textit{Note --- Significant changes are specified in Annex 3, Chapter 4. However, if the controller possesses wind information in the form of components, the significant changes are:}
    ...
    \begin{enumerate}[itemsep=0.2cm]\centering
        ...
        \begin{enumerate}
            ...
            \begin{enumalph}
                ...
                \textit{Note --- Guidance material pertaining to use of ADS-B and multilateration (MLAT) systems and their system performance is contained in the \emph{Assessment of ADS-B and Multilateration Surveillance to Support Air Traffic Services and Guidelines for Implementation} (Cir 326).}
            ...
            \textit{Note --- There is no requirement to advise the aircraft that flight path monitoring using radar is terminated.}
        \end{enumerate}
