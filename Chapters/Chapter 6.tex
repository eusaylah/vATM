...
\section[Separation in the Vicinity of Aerodromes]{\texorpdfstring{SEPARATION IN THE VICINITY OF AERODROMES}{}} \label{6}
...
\begin{enumeratesc}
    ...
    \item \label{6.7.3.2} \textsc{Requirements and procedures for \\ independent parallel departures}
    \begin{enumempty}
